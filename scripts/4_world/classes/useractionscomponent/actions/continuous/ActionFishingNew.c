modded class ActionFishingNew
{
	override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
	{
		...
		array<Object> objects = ZenFunctionsIceLakes.GetObjectsRayCastCamera(UAMaxDistances.BASEBUILDING * 2);
		array<Object> objects2 = ZenFunctionsIceLakes.GetObjectsRayCastBeneath();
